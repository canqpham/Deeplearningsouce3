# Created by canqpham at 2019-04-01
...
if __name__ == '__main__':
    acgan = ACGAN()
    acgan.train(X_train, y_train, epochs=11, batch_size=32, sample_interval=10)
#we can see the Discriminator and Generator architecture
fashion_acgan = ACGAN()

g_loss, d_loss = fashion_acgan.train(X_train, y_train, epochs=11, batch_size=100, sample_interval=10) #200 epoch luu 1 lan
